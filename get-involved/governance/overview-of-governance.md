...
will need to evolve, and we encourage improvement proposals from the community.
{% endhint %}
...
system. By focusing on open and transparent protocol development, and then evolving the system with
attestations as a measure of contribution and stakeholder interest, Verax sets the stage for a governance model both scalable and equitable.&#x20;
...
protocol investment. Yet, founding teams and core contributors prioritize technological advancements and
...
The above encapsulates the idea that a governance system should strive to find the optimal balance of these three elements
...
wheels” will be removed to further decentralize control over the protocol. This is to ensure the safety of the
protocol in the early stages of its development, and broadly aligns with the idea of progressive decentralization.
...
Governance is not meant to be static, but rather evolve as the community grows. Therefore, the governance
process will be reviewed on an ongoing basis, and feedback is welcome from the community and how the protocol is
governed.

While the core protocol and infrastructure are still under development, the core council will retain veto power, but this
...
there have been several promising pieces of research into how this could be achieved (e.g. [DAO Decentralization: Voting-Bloc Entropy, Bribery and Dark DAOs](https://arxiv.org/abs/2311.03530), or
...
it will require a significant amount of attestations from diverse sources to create a system that is robust
enough to safely govern a protocol. The object is that this is what governance will evolve into time.

As well as the voting mechanism, the actual structure of governance will likely evolve as well. The diagram
below illustrates some of the various concerns that governance will need to address over time and how they could
