...
Attestations are created through things called "[portals](portals.md)" that make sure the attestations are consistent with the logic of a specific domain.

Attestations are created following "[schemas](schemas.md)", which describe the structure of the attestation data, i.e. the various fields and their respective data types.
